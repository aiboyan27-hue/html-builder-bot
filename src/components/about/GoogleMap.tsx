    ...
    <section className="relative">
      ...
      <div className="absolute bottom-6 right-6">
        <a
          ...
          className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-lg font-semibold text-sm uppercase tracking-wide transition-colors"
        >
          Open in Google Map
