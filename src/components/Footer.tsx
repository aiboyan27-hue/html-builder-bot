        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/auranettoyage" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/auranettoyage" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.tiktok.com/@auranettoyage" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-primary-foreground/70">
              ...
              <li>
                <Link to="/soumission" className="hover:text-primary-foreground transition-colors">
                  Obtenir une soumission
                </Link>
              </li>
              <li>
                <Link to="/apropos" className="hover:text-primary-foreground transition-colors">
                  À propos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/privacy" className="hover:text-primary-foreground transition-colors">Politique de confidentialité</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-primary-foreground/70">
              {services.map(service => <li key={service.slug}>
                  <Link to={`/services/${service.slug}`} className="hover:text-primary-foreground transition-colors">
                    {service.title}
                  </Link>
                </li>)}
            </ul>
